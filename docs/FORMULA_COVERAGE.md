...
Theory breadth is now ahead of equation curation: `formula-audit.js` reports **198 formula-bearing gaps** after the 367-node census expansion. Those gaps are deliberate, visible work items rather than silently invented equations.
