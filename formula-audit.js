(() => {
  ...
  function priority(theory, classification) {
    ...
    if (["Quantum chemistry & electronic structure","Quantum many-body & condensed matter","Quantum field theory","Quantum gravity & spacetime","Quantum information & open systems","Formulations"].includes(theory.category)) return "high";
    return "medium";
  }
